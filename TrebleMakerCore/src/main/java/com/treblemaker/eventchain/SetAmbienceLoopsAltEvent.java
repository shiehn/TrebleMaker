...
public class SetAmbienceLoopsAltEvent implements IEventChain {
    ...
    public QueueState set(QueueState queueState ) {
        return ambienceGenerator.generateAndSetAmbienceLoops(queueState, Composition.Layer.AMBIENCE_LOOP_ALT);
    }
}