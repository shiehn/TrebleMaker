...
public class ParametricEqArrays {
    ...
    public ParametricEqArrays(int arraySize){

        freq20 = new double[arraySize];
        freq25 = new double[arraySize];
        freq31 = new double[arraySize];
        freq40 = new double[arraySize];
        freq50 = new double[arraySize];
        freq63 = new double[arraySize];
        freq80 = new double[arraySize];
        freq100 = new double[arraySize];
        freq125 = new double[arraySize];
        freq160 = new double[arraySize];
        freq200 = new double[arraySize];
        freq250 = new double[arraySize];
        freq315 = new double[arraySize];
        freq400 = new double[arraySize];
        freq500 = new double[arraySize];
        freq630 = new double[arraySize];
        freq800 = new double[arraySize];
        freq1000 = new double[arraySize];
        freq1250 = new double[arraySize];
        freq1600 = new double[arraySize];
        freq2000 = new double[arraySize];
        freq2500 = new double[arraySize];
        freq3150 = new double[arraySize];
        freq4000 = new double[arraySize];
        freq5000 = new double[arraySize];
        freq6300 = new double[arraySize];
        freq8000 = new double[arraySize];
        freq10000 = new double[arraySize];
        freq12500 = new double[arraySize];
        freq16000 = new double[arraySize];
        freq20000 = new double[arraySize];
    }
