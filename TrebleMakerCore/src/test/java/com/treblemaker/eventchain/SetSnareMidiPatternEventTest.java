...
public class SetSnareMidiPatternEventTest {
    ...
    public void shouldSetMidiPattern(){
        ...
        assertThat(p1b1.toString()).isEqualToIgnoringCase("T77 f#3s rs f#3s rs f#3s rs f#3s rs f#3s rs f#3s rs f#3s rs f#3s rs ");
        assertThat(p2b1.toString()).isEqualToIgnoringCase("T77 rs rs f#3s f#3s rs rs f#3s f#3s rs rs f#3s f#3s rs rs f#3s f#3s ");
    }
