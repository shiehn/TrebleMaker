...
export TM_ROOT_DIR=/Users/pivotal/TrebleMaker
...
export TM_BYPASS_RHYTHM_RATING=true
export TM_BYPASS_BASSLINE_RATING=true
export TM_BYPASS_ARPEGGIO_RATING=true
export TM_BYPASS_HARMONIC_LOOP_RATING=true
export TM_BYPASS_BEAT_LOOP_RATING=true
export TM_BYPASS_SEQUENCE_RATING=true
export TM_BYPASS_EQ_RATING=true
export TM_BYPASS_ANALYTICS=false
export TM_BYPASS_EQ_ANALYTICS=true
